...
%tox -e %{default_toxenv} -- -- -k 'not test_dispatch_opcode_notify_different_serial and not test_dispatch_opcode_notify_same_serial and not test_notify_same_serial and not designate.tests.unit.mdns.test_handler.MdnsHandleTest.test_notify'
